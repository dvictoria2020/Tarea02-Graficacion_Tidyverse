...
# Carga de librería dplyr
library(dplyr)

# Carga de librería graphics
library(graphics)

# Carga de librería ggplot2
library(ggplot2)

# Carga de librería plotly
library(plotly)

# Carga de librería tidyverse
library(tidyverse)

# Carga de librería hrbrthemes
library(hrbrthemes)
```
...
ggplot() + geom_col(
  ...
  aes(x = mes, y= c_bananito, fill = "bananito"), width = 0.7
)+
  geom_col(
    data= rios_sumarizado_x_mes,
    aes(x = mes, y = c_pandora, fill = "pandora"), width = 0.7
) +
...
ggplot() + geom_col(
  ...
  aes(x = mes, y = suma_hombres_fallecidos, fill = "hombres fallecidos"),
  width = 0.4, 
  position= "dodge"
  ...
  geom_col (
    data = covid_sumarizado_x_mes,
    aes(x = mes, y = suma_mujeres_fallecidas, fill = "mujeres fallecidas"),
    width = 0.4,
    position= "dodge"
    )+
